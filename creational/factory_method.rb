...
# Implementation defines a interface for creating objects, but let subclass to decide which class to instantiate.
# Implementation refers to the newly created object through a common interface.
#
#
#
class Printer
